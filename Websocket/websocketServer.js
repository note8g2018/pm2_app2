...
//const WEBSOCKET_IP = '192.168.1.100';
const WEBSOCKET_IP = 'coolme.me';
...
http_server.listen(WEBSOCKET_PORT, WEBSOCKET_IP); // http://localhost:3000/sockserver/websocket
console.log(`The Websocket server is listing on:
ws://${WEBSOCKET_IP}:${WEBSOCKET_PORT}/sockserver/websocket`);
